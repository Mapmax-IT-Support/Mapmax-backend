const Constants = {
   ...
   //'http://localhost:3000',
    ...
    CENSUS_API : 'https://api.census.gov/data/2019/acs/acs5?key=28a04efd887ab5cf335f99aabcde1978452de2cf',
    TIGER_WEB_ZIP: 'https://tigerweb.geo.census.gov/arcgis/rest/services/TIGERweb/tigerWMS_ACS2017/Mapserver/2/query?geometryType=esriGeometryPoint&inSR=4269&spatialRel=esriSpatialRelIntersects&returnGeometry=false&f=pjson&outFields=ZCTA5',
    S3_BUCKET: 'landmarkbucket2',
    ...
    POPULATION : {
        ...
        GENDER : {
            MALE : {
                ...
                TWENTYTWO_TWENTYFOUR : "B01001_010E", // 22-24
                ...
                FIFTYFIVE_FIFTYNINE : "B01001_017E", // 55-59
            ...
            FEMALE : {
                ...
                TWENTYONE : "B01001_033E", // 21
                TWENTYTWO_TWENTYFOUR : "B01001_034E", // 22-24
                ...
                FIFTYFIVE_FIFTYNINE : "B01001_041E", // 55-59
        ...
        RACE : {
         ...
         RELATIONSHIP: {
             ...
             FEMALE : {
                MARRIED: "B12001_013E",
                NEVER_MARRIED: "B12001_012E",
                DIVORCED: "B12001_019E",
             }
